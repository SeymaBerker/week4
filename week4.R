...
#Hi Seyma, some suggestions that might help!
## You should include the Janitor library and run clean_names on the datasets used
## I have added the data files into the project as I can't get the code to run 
## as you are using paths to your computer

# I have copied my response below - I have done it quite differently, I hope this helps.
